...
export class UsersController {
  ...
  @UseGuards(RolesGuard)
  @Roles(UserRole.SUPER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.ADMIN)
  @ApiOperation({ summary: 'Get user by ID (Admin/Company Admin/Super Admin only)' })
  ...
  @UseGuards(RolesGuard)
  @Roles(UserRole.SUPER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.ADMIN)
  @ApiOperation({ summary: 'Update user by ID (Admin/Company Admin/Super Admin only)' })
  ...
  @UseGuards(RolesGuard)
  @Roles(UserRole.SUPER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.ADMIN)
  @ApiOperation({ summary: 'Update user status (Admin/Company Admin/Super Admin only)' })
  ...
  @ApiOperation({ summary: 'Retire user (Super Admin/Company Admin only)' })
  ...
  @UseGuards(RolesGuard)
  @Roles(UserRole.SUPER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.ADMIN)
  @ApiOperation({ summary: 'Reset user password (Admin/Company Admin/Super Admin only)' })
  ...
  @UseGuards(RolesGuard)
  @Roles(UserRole.SUPER_ADMIN, UserRole.COMPANY_ADMIN, UserRole.ADMIN)
  @ApiOperation({ summary: 'Manually reset user password (Admin/Company Admin/Super Admin only)' })
