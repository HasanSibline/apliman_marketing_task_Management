...
const CalendarPage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-primary-600 to-indigo-700 p-8 rounded-3xl text-white">
                ...
                <button
                    onClick={fetchTasks}
                    className="flex items-center gap-2 px-5 py-2.5 bg-white text-primary-700 rounded-2xl font-bold text-sm hover:scale-105 transition active:scale-95 border border-primary-200"
                >
            ...
            {loading ? (
                ...
                <div className="p-20 text-center bg-white rounded-3xl border border-gray-200">
                    ...
                    <button onClick={() => navigate('/tasks')} className="mt-6 px-6 py-3 bg-primary-600 text-white rounded-2xl font-bold hover:bg-primary-700 transition">Go to Tasks</button>
                </div>
            ) : (
