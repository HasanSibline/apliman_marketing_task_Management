            ...
            <div className="md:flex md:items-center md:justify-between mb-8">
                ...
                <div className="mt-4 flex md:mt-0 md:ml-4">
                    <button
                        ...
                        className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                    >
                        ...
                        <div className="p-6">
                            ...
                            <ul className="space-y-3 mb-6">
                                ...
                                <li className="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                    ...
                                    AI Features: <span className={`ml-1 font-semibold ${plan.aiEnabled ? 'text-amber-600 dark:text-amber-400' : 'text-gray-400'}`}>{plan.aiEnabled ? 'Enabled' : 'Disabled'}</span>
                                </li>
                            </ul>
                            ...
                            <div className="flex space-x-2 mt-4 border-t pt-4">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center p-2 border border-red-200 text-red-600 dark:text-red-400 rounded-md hover:bg-red-50 dark:hover:bg-red-900/30"
                                    title="Delete Plan"
                                >
