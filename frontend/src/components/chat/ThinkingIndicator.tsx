...
const PHRASES: { at: number; text: string }[] = [
  ...
  { at: 8, text: 'Looking through what it knows' },
  { at: 14, text: 'Preparing your answer' },
  { at: 22, text: 'Still going, this one is taking a moment' },
  { at: 34, text: 'Waking the service up, thanks for waiting' },
  { at: 50, text: 'Nearly there, finalising your answer' },
]
...
const ThinkingIndicator: React.FC = () => {
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="flex h-8 items-center gap-2.5 rounded-full border border-gray-100 bg-white px-4 dark:border-gray-700 dark:bg-gray-800">
        ...
        {/* One line at a time, crossfading, so the change is noticed without the
            message jumping about. aria-live announces it once per change rather than
            on every render. */}
        <span className="relative block min-w-[13rem] overflow-hidden text-xs text-gray-600 dark:text-gray-300">
